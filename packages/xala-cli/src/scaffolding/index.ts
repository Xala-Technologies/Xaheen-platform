...
// ===== VIRTUAL FILESYSTEM =====
export { VirtualFS, createVirtualFS } from './virtual-fs.js';
...
import { ServiceIntegratedOrchestrator, createScaffoldingServiceRegistry } from './service-integration.js';

/**
 * Create a new hybrid scaffolding orchestrator with all tiers integrated
 */
export function createHybridScaffolder(projectPath: string): ServiceIntegratedOrchestrator {
 ...
 */
export function createBasicOrchestrator(projectPath: string): import('./hybrid-orchestrator.js').HybridScaffoldingOrchestrator {

...
export async function checkForUpdates(
	...
	try {
		...
		const response = await fetch(
			"https://registry.npmjs.org/@xala-technologies/xala-cli/latest",
			{
...
function displayUpdateNotification(updateInfo: UpdateInfo): void {
	...
	console.log(
		chalk.yellow("│") +
			"  " +
			chalk.dim(`Current: ${updateInfo.current}`) +
			"                         " +
			chalk.yellow("│"),
	);
	console.log(
		chalk.yellow("│") +
			"  " +
			chalk.green(`Latest:  ${updateInfo.latest}`) +
			"                         " +
			chalk.yellow("│"),
	);
	console.log(
	...
	console.log(
		chalk.yellow("│") +
			"  " +
			chalk.cyan(updateInfo.updateCommand) +
			" " +
			chalk.yellow("│"),
	);
	console.log(

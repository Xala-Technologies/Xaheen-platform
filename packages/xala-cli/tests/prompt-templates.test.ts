...
const PROMPT_TEMPLATES = {
	...
	"13b": {
		button:
			"Create a button component with {variant} variant, {size} size, and onClick handler",
		input:
			"Generate an input field with {type} type, validation, and error state",
		card: "Build a card component with header, content, footer, and {elevation} elevation",
		modal:
			"Create a modal dialog with backdrop, close button, and {animation} animation",
		...
		navbar:
			"Create a responsive navigation bar with logo, menu items, and mobile toggle",
		dashboard:
			"Generate a dashboard layout with sidebar, header, and main content area",
	},

	// 70B+ Model Templates - Full descriptions
	"70b": {
		button:
			"Create a fully accessible button component with multiple variants (primary, secondary, outline, ghost), sizes (sm, md, lg, xl), loading states, icons support, and proper ARIA attributes",
		input:
			"Generate a comprehensive input component with multiple types, validation states, helper text, icons, clear button, character count, and full accessibility support",
		...
		modal:
			"Create a feature-rich modal with animations, backdrop blur, focus trap, escape key handling, multiple sizes, and proper accessibility",
		...
		table:
			"Build an enterprise data table with virtual scrolling, column resizing, filtering, sorting, row selection, export functionality, and responsive design",
		navbar:
			"Create a production-ready navigation system with responsive design, dropdown menus, search, notifications, user menu, and breadcrumbs",
		dashboard:
			"Generate a complete dashboard with collapsible sidebar, customizable widgets, real-time updates, responsive grid, and theme switching",
	},
};
...
describe("Prompt Template Tests for Small LLMs", () => {
	describe("7B Model Prompt Templates", () => {
		...
		it("should generate all 7B prompts under 100 characters", () => {
			for (const [component, template] of Object.entries(
				PROMPT_TEMPLATES["7b"],
			)) {
		...
		it("should chunk complex requests for 7B models", async () => {
			const complexRequest =
				"Create a complete e-commerce dashboard with user management, product catalog, order tracking, analytics, and real-time notifications";
	...
	describe("Prompt Optimization", () => {
		it("should optimize prompt based on model size", () => {
			const originalPrompt =
				"Create a sophisticated enterprise-grade dashboard with comprehensive analytics, real-time data visualization, and advanced filtering capabilities";
	...
	describe("Template Variable Substitution", () => {
		it("should handle variable substitution correctly", () => {
			const template =
				"Create {type} component with {variant} style and {size} size";
			const variables = {
				type: "button",
				variant: "primary",
				size: "large",
			...
			expect(result).toBe(
				"Create button component with primary style and large size",
			);
		});
	...
	describe("Complexity Scoring", () => {
		it("should score prompt complexity correctly", () => {
			...
			const mediumPrompt =
				"Create a button component with primary variant and click handler";
			const complexPrompt =
				"Create a fully accessible button component with multiple variants, sizes, loading states, and ARIA attributes";
		...
		it.skip("should recommend model size based on complexity", () => {
			const prompts = [
				...
				{
					prompt: "sophisticated button with advanced features",
					expected: "13b",
				},
...
function getComplexityScore(prompt: string): number {
	...
	const complexCount = complexWords.filter((w) =>
...
function getProgressiveRecovery(
	component: string,
	attempt: number,
	modelSize: string,
): string {

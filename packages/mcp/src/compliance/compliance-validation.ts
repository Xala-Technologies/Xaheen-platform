  ...
  private static async validateNSMCompliance(
    ...
    try {
      ...
      violations.push({
        ...
        message: `NSM validation failed: ${error.message}`,
  ...
  private static async validateAltinnCompliance(
    ...
    try {
      ...
      violations.push({
        ...
        message: `Altinn validation failed: ${error.message}`,
  ...
  private static async validateLocalizationCompliance(
    ...
    try {
      ...
      violations.push({
        ...
        message: `Localization validation failed: ${error.message}`,
  ...
  private static async validateRTLCompliance(
    ...
    try {
      ...
      violations.push({
        ...
        message: `RTL validation failed: ${error.message}`,

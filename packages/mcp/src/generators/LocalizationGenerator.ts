...
export class LocalizationGenerator {
	...
	private generateCategorySpecificKeys(
	...
	private generateFeatureSpecificKeys(
		config: ComponentConfig,
	): Record<string, any> {
	...
	private generateDataDisplayKeys(
		config: ComponentConfig,
	): Record<string, any> {
		return {
			table: {
	...
	private generateInteractiveKeys(
		config: ComponentConfig,
	): Record<string, any> {
		return {
			dialog: {
	...
	private generatePageTemplateKeys(
		config: ComponentConfig,
	): Record<string, any> {
		return {
			page: {

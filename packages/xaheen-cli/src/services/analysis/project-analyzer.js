...
export class ProjectAnalyzer {
    ...
    async detectFramework(projectInfo) {
        const deps = {
    ...
    async detectBackend(projectInfo) {
        const deps = {
            ...projectInfo.dependencies,
            ...projectInfo.devDependencies,
        };
    ...
    async detectDatabase(projectInfo) {
        const deps = {
            ...projectInfo.dependencies,
            ...projectInfo.devDependencies,
        };
    ...
    async detectServices(projectPath, projectInfo) {
        const services = [];
        const deps = {
            ...projectInfo.dependencies,
            ...projectInfo.devDependencies,
    ...
    async detectPlatform(projectInfo) {
        const deps = {
            ...projectInfo.dependencies,
            ...projectInfo.devDependencies,
        };
    ...
    detectServiceFromFileName(fileName) {

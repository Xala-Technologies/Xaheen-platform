...
export class MCPClient {
    ...
    async findSpecificationPath(componentName, category) {
        const possiblePaths = [];
        if (category) {
            possiblePaths.push(path.join(this.mcpPath, `docs/specifications/components/${category}/${componentName}.json`), path.join(this.mcpPath, `docs/specifications/components/${category}/${componentName.toLowerCase()}.json`));
        }
        else {
            ...
            for (const cat of categories) {
                possiblePaths.push(path.join(this.mcpPath, `docs/specifications/components/${cat}/${componentName}.json`), path.join(this.mcpPath, `docs/specifications/components/${cat}/${componentName.toLowerCase()}.json`));
            }
        }

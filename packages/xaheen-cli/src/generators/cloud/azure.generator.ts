...
export class AzureGenerator extends BaseGenerator {
	...
	readonly description =
		"Generate Azure cloud infrastructure and services with comprehensive coverage";
	...
	async generate(
		...
		try {
			...
			throw new Error(
				`Azure generator failed: ${error instanceof Error ? error.message : "Unknown error"}`,
			);
		}
	}
	...
	private validateOptions(options: AzureGeneratorOptions): void {
		...
		if (
			options.enableAiServices &&
			(!options.aiServices || options.aiServices.length === 0)
		) {
			throw new Error(
				"AI services must be specified when AI services are enabled",
			);
		}
	}
	...
	private async generateBaseConfiguration(
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/configs/azure.config.ts.hbs",
				{
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/core/azure-client.factory.ts.hbs",
				{
					subscriptionId: options.subscriptionId,
					tenantId: options.tenantId,
					enableDiagnostics: options.enableDiagnostics,
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/types/azure.types.ts.hbs",
				{
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/configs/env.azure.example.hbs",
				{
					subscriptionId: options.subscriptionId,
					tenantId: options.tenantId,
					resourceGroupName: options.resourceGroupName,
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/configs/package.azure.json.hbs",
				{
					servicesToGenerate: options.servicesToGenerate,
	...
	private async generateAzureFunctions(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/functions/host.json.hbs",
				{
					environment: options.environment,
					enableDiagnostics: options.enableDiagnostics,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/functions/local.settings.json.hbs",
				{
					subscriptionId: options.subscriptionId,
					resourceGroupName: options.resourceGroupName,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/functions/http-trigger.ts.hbs",
				{
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/functions/timer-trigger.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
		...
		if (options.enableServiceBus) {
			operations.push({
				...
				content: await this.renderTemplate(
					"cloud/azure/functions/service-bus-trigger.ts.hbs",
					{
						enableDiagnostics: options.enableDiagnostics,
					},
				),
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/functions/utils/function-utils.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateServiceBus(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/service-bus/service-bus.client.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
					enableKeyVault: options.enableKeyVault,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/service-bus/message-sender.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/service-bus/message-receiver.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/service-bus/dead-letter-handler.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
	...
	private async generateSqlDatabase(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/database/azure-sql.connection.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/database/entity-framework.setup.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/database/migrations/initial-migration.ts.hbs",
				{
					environment: options.environment,
				},
			),
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/database/repositories/base.repository.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
	...
	private async generateActiveDirectory(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/auth/azure-ad.auth.ts.hbs",
				{
					tenantId: options.tenantId,
					enableDiagnostics: options.enableDiagnostics,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/auth/jwt-validator.ts.hbs",
				{
					tenantId: options.tenantId,
					enableDiagnostics: options.enableDiagnostics,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/auth/rbac.middleware.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/auth/graph-api.client.ts.hbs",
				{
					tenantId: options.tenantId,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateKeyVault(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/key-vault/key-vault.client.ts.hbs",
				{
					tenantId: options.tenantId,
					enableDiagnostics: options.enableDiagnostics,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/key-vault/secrets.manager.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/key-vault/certificates.manager.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/key-vault/encryption.manager.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
	...
	private async generateAiServices(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/ai-services/ai-services.factory.ts.hbs",
				{
					aiServices: options.aiServices,
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
	...
	private async generateAiService(
		...
		switch (service) {
			case "openai":
				operations.push({
					...
					path: join(
						options.outputPath,
						"ai-services/openai/azure-openai.client.ts",
					),
					content: await this.renderTemplate(
						"cloud/azure/ai-services/openai/azure-openai.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "cognitive-services":
				operations.push({
					...
					path: join(
						options.outputPath,
						"ai-services/cognitive-services/cognitive-services.client.ts",
					),
					content: await this.renderTemplate(
						"cloud/azure/ai-services/cognitive-services/cognitive-services.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "document-intelligence":
				operations.push({
					...
					path: join(
						options.outputPath,
						"ai-services/document-intelligence/document-intelligence.client.ts",
					),
					content: await this.renderTemplate(
						"cloud/azure/ai-services/document-intelligence/document-intelligence.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "speech":
				operations.push({
					...
					content: await this.renderTemplate(
						"cloud/azure/ai-services/speech/speech.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "vision":
				operations.push({
					...
					content: await this.renderTemplate(
						"cloud/azure/ai-services/vision/vision.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "language":
				operations.push({
					...
					path: join(
						options.outputPath,
						"ai-services/language/language.client.ts",
					),
					content: await this.renderTemplate(
						"cloud/azure/ai-services/language/language.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "translator":
				operations.push({
					...
					path: join(
						options.outputPath,
						"ai-services/translator/translator.client.ts",
					),
					content: await this.renderTemplate(
						"cloud/azure/ai-services/translator/translator.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "bot-service":
				operations.push({
					...
					path: join(
						options.outputPath,
						"ai-services/bot-service/bot-service.client.ts",
					),
					content: await this.renderTemplate(
						"cloud/azure/ai-services/bot-service/bot-service.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "machine-learning":
				operations.push({
					...
					path: join(
						options.outputPath,
						"ai-services/machine-learning/ml.client.ts",
					),
					content: await this.renderTemplate(
						"cloud/azure/ai-services/machine-learning/ml.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
			...
			case "custom-vision":
				operations.push({
					...
					path: join(
						options.outputPath,
						"ai-services/custom-vision/custom-vision.client.ts",
					),
					content: await this.renderTemplate(
						"cloud/azure/ai-services/custom-vision/custom-vision.client.ts.hbs",
						{
							enableKeyVault: options.enableKeyVault,
							enableDiagnostics: options.enableDiagnostics,
						},
	...
	private async generateAppService(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/app-service/app-service.config.ts.hbs",
				{
					environment: options.environment,
					enableDiagnostics: options.enableDiagnostics,
					customDomain: options.customDomain,
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/app-service/deployment-slots.config.ts.hbs",
				{
					environment: options.environment,
				},
			),
	...
	private async generateStorageAccount(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/storage/storage.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/storage/blob-storage.service.ts.hbs",
				{
					enableDiagnostics: options.enableDiagnostics,
				},
			),
	...
	private async generateCosmosDb(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/cosmos-db/cosmos-db.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateRedisCache(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/redis-cache/redis-cache.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateApplicationInsights(
		...
		operations.push({
			...
			path: join(
				options.outputPath,
				"monitoring/application-insights.client.ts",
			),
			content: await this.renderTemplate(
				"cloud/azure/monitoring/application-insights.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
				},
			),
	...
	private async generateLogAnalytics(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/monitoring/log-analytics.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
				},
			),
	...
	private async generateApiManagement(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/api-management/apim.config.ts.hbs",
				{
					customDomain: options.customDomain,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateEventGrid(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/event-grid/event-grid.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateEventHubs(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/event-hubs/event-hubs.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateNotificationHubs(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			path: join(
				options.outputPath,
				"notification-hubs/notification-hubs.client.ts",
			),
			content: await this.renderTemplate(
				"cloud/azure/notification-hubs/notification-hubs.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateSearchService(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/search-service/search-service.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateContainerRegistry(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/container-registry/acr.client.ts.hbs",
				{
					enableKeyVault: options.enableKeyVault,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateKubernetesService(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/kubernetes-service/aks.config.ts.hbs",
				{
					environment: options.environment,
					enableDiagnostics: options.enableDiagnostics,
				},
	...
	private async generateInfrastructure(
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/infrastructure/terraform/main.tf.hbs",
				{
					resourceGroupName: options.resourceGroupName,
					location: options.location,
					servicesToGenerate: options.servicesToGenerate,
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/infrastructure/arm/azuredeploy.json.hbs",
				{
					resourceGroupName: options.resourceGroupName,
					location: options.location,
					servicesToGenerate: options.servicesToGenerate,
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/infrastructure/bicep/main.bicep.hbs",
				{
					resourceGroupName: options.resourceGroupName,
					location: options.location,
					servicesToGenerate: options.servicesToGenerate,
	...
	private async generateMonitoring(
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/monitoring/dashboard.json.hbs",
				{
					resourceGroupName: options.resourceGroupName,
					servicesToGenerate: options.servicesToGenerate,
				},
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/monitoring/alerts.config.ts.hbs",
				{
					servicesToGenerate: options.servicesToGenerate,
					environment: options.environment,
				},
	...
	private async generateSecurityConfig(
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/security/security.config.ts.hbs",
				{
					useEntraId: options.useEntraId,
					enableKeyVault: options.enableKeyVault,
					environment: options.environment,
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/security/network-security-groups.tf.hbs",
				{
					resourceGroupName: options.resourceGroupName,
					location: options.location,
					environment: options.environment,
	...
	private async generateDevOpsPipelines(
		options: AzureGeneratorOptions,
	): Promise<readonly FileOperation[]> {
		const operations: FileOperation[] = [];
		...
		operations.push({
			...
			content: await this.renderTemplate(
				"cloud/azure/github/azure-deploy.yml.hbs",
				{
					resourceGroupName: options.resourceGroupName,
					subscriptionId: options.subscriptionId,
					environment: options.environment,

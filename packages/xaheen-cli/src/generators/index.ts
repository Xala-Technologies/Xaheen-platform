			...
			case "database":
				if (type === "migration") {
					...
					return await migrationGenerator.generate({
						...
						norwegian: options.norwegian,
						dataCompliance: options.dataCompliance,
						typescript: options.typescript !== false,
						dryRun: options.dryRun,
						force: options.force,
					});
					...
					return await seedGenerator.generate({
						...
						recordCount: options.recordCount ? parseInt(options.recordCount) : undefined,
						locale: options.locale,
						relationships: options.relationships,
						gdprCompliant: options.gdprCompliant,
			...
			case "testing":
				if (type === "test") {
					...
					return await testGenerator.generate({
						...
						testTypes: options.testTypes ? options.testTypes.split(',') as any : undefined,
						framework: options.framework,
						testingLibrary: options.testingLibrary,

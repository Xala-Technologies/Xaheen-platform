 ...
 */
function getGeneratorCategory(type: GeneratorType): keyof typeof GENERATOR_CATEGORIES | null {
 ...
 */
async function executeFrontendGenerator(context: GeneratorContext): Promise<GeneratorResult> {
 ...
 */
async function executeFullStackGenerator(context: GeneratorContext): Promise<GeneratorResult> {
  const { type, name, options } = context;
 ...
 */
async function executeScaffoldGenerator(context: GeneratorContext): Promise<GeneratorResult> {
 ...
 */
async function executeCrudGenerator(context: GeneratorContext): Promise<GeneratorResult> {
  const { name, options } = context;
 ...
 */
async function executeAuthGenerator(context: GeneratorContext): Promise<GeneratorResult> {
 ...
 */
async function executeFeatureGenerator(context: GeneratorContext): Promise<GeneratorResult> {
  const { name } = context;
 ...
 */
async function executeIntegrationGenerator(context: GeneratorContext): Promise<GeneratorResult> {
 ...
 */
async function executeTestingGenerator(context: GeneratorContext): Promise<GeneratorResult> {
  const { type, name } = context;
 ...
 */
async function executeConfigGenerator(context: GeneratorContext): Promise<GeneratorResult> {
  const { type, name } = context;
 ...
 */
export async function executeFullStackGenerator(context: GeneratorContext): Promise<GeneratorResult> {
  const { type } = context;
...
export function isGeneratorSupported(type: string): type is GeneratorType {
  return Object.values(GENERATOR_CATEGORIES).flat().includes(type as GeneratorType);
}

...
export class DocumentationGeneratorFactory {
   ...
   */
  static async generateComprehensiveDocumentation(options: DocumentationGeneratorOptions): Promise<DocumentationResult> {
    ...
    try {
      ...
      if (options.enableTroubleshooting) {
        const troubleshootingGenerator = this.createTroubleshootingDocsGenerator();

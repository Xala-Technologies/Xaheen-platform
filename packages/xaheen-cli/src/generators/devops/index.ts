...
export const DEVOPS_PRESETS = {
  microservice: {
    ...
    features: ['ci', 'cd', 'security', 'monitoring', 'distributed-tracing', 'custom-metrics']
  },
  webapp: {
  ...
  api: {
    platforms: ['docker', 'kubernetes', 'github-actions', 'monitoring'],
    features: ['ci', 'cd', 'security', 'testing', 'monitoring', 'custom-metrics']
  },
  fullstack: {
    platforms: ['docker', 'kubernetes', 'github-actions', 'monitoring'],
    features: ['ci', 'cd', 'security', 'testing', 'monitoring', 'distributed-tracing', 'log-correlation']
  },
  observability: {
    platforms: ['monitoring'],
    features: ['prometheus', 'grafana', 'opentelemetry', 'jaeger', 'loki', 'alertmanager', 'distributed-tracing', 'custom-metrics', 'log-correlation', 'sli-slo']
  }
} as const;

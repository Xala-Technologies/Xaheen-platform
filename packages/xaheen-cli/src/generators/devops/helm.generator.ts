...
export class HelmGenerator extends BaseGenerator<HelmGeneratorOptions> {
  ...
  async generate(options: HelmGeneratorOptions): Promise<void> {
    try {
  ...
  private async validateOptions(options: HelmGeneratorOptions): Promise<void> {
  ...
  private async createChartStructure(options: HelmGeneratorOptions): Promise<void> {
    const directories = [
  ...
  private async generateChartYaml(options: HelmGeneratorOptions): Promise<void> {
    const chartData = {
  ...
  private async generateValuesYaml(options: HelmGeneratorOptions, projectContext: any): Promise<void> {
    const values = {
      // Global values
      global: {
        imageRegistry: '',
  ...
  private async generateValuesSchema(options: HelmGeneratorOptions): Promise<void> {
    const schema = {
  ...
  private async generateTemplates(options: HelmGeneratorOptions): Promise<void> {
    const templates = [
      'deployment.yaml',
      'service.yaml',
      'serviceaccount.yaml',
  ...
  private async generateHelpers(options: HelmGeneratorOptions): Promise<void> {
    const helpers = {
      chartName: options.chartName,
      templates: {
...
{{- end }}`
  ...
  private async generateNotes(options: HelmGeneratorOptions): Promise<void> {
    const notes = {
      chartName: options.chartName,
  ...
  private async generateHooks(options: HelmGeneratorOptions): Promise<void> {
  ...
  private async generateTests(options: HelmGeneratorOptions): Promise<void> {
  ...
  private async generateEnvironmentValues(options: HelmGeneratorOptions): Promise<void> {
  ...
  private async generateDeploymentScripts(options: HelmGeneratorOptions): Promise<void> {
    const scripts = {
  ...
  private async generateCIPipelines(options: HelmGeneratorOptions): Promise<void> {
  ...
  private async generateMonitoring(options: HelmGeneratorOptions): Promise<void> {
  ...
  private async generateBackup(options: HelmGeneratorOptions): Promise<void> {
  ...
  private async generateSecurity(options: HelmGeneratorOptions): Promise<void> {
  ...
  private async generateReadme(options: HelmGeneratorOptions): Promise<void> {
    const readme = {
      chartName: options.chartName,
      description: options.description,
      version: options.chartVersion,
  ...
  // Helper methods
  private transformHelmValues(values: readonly HelmValue[]): Record<string, any> {
  ...
  private getEnvironmentSpecificValues(options: HelmGeneratorOptions, env: string): any {
    const baseValues = {
      global: {
        environment: env
      }
  ...
  private generateInstallScript(options: HelmGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private generateUpgradeScript(options: HelmGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private generateRollbackScript(options: HelmGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private generateUninstallScript(options: HelmGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private generateTestScript(options: HelmGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private generateLintScript(options: HelmGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private generatePackageScript(options: HelmGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private generateDeployScript(options: HelmGeneratorOptions): string {
    return `#!/bin/bash
set -e

...
export class HelmGenerator extends BaseGenerator<HelmGeneratorOptions> {
	...
	private async createChartStructure(
	...
	private async generateValuesSchema(
		options: HelmGeneratorOptions,
	): Promise<void> {
		const schema = {
...
{{- end }}`,
	...
	private async generateEnvironmentValues(
		options: HelmGeneratorOptions,
	): Promise<void> {
	...
	private async generateCIPipelines(
		options: HelmGeneratorOptions,
	): Promise<void> {

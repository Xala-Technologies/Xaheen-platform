...
export interface DockerComposeService {
  ...
  readonly dependsOn?: readonly string[] | Record<string, { readonly condition: string }>;
  ...
  readonly ulimits?: Record<string, number | { readonly soft: number; readonly hard: number }>;
}
...
export class DockerComposeGenerator extends BaseGenerator<DockerComposeGeneratorOptions> {
  ...
  private async validateOptions(options: DockerComposeGeneratorOptions): Promise<void> {
  ...
  private async generateEnvironmentOverrides(options: DockerComposeGeneratorOptions): Promise<void> {
  ...
  private async generateDevelopmentCompose(options: DockerComposeGeneratorOptions): Promise<void> {
  ...
  private async generateProductionCompose(options: DockerComposeGeneratorOptions): Promise<void> {
    const prodData = {
      version: options.version,
  ...
  private async generateTraefikConfig(options: DockerComposeGeneratorOptions): Promise<void> {
    const traefikConfig = {
      api: {
        dashboard: true,
  ...
  private async generateObservabilityStack(options: DockerComposeGeneratorOptions): Promise<void> {
  ...
  private async generateLoggingStack(options: DockerComposeGeneratorOptions): Promise<void> {
  ...
  private async generateBackupConfig(options: DockerComposeGeneratorOptions): Promise<void> {
    const backupConfig = {
      services: {
        backup: {
          image: 'alpine:latest',
...
`;
  ...
  private async generateSSLConfig(options: DockerComposeGeneratorOptions): Promise<void> {
  ...
  private async generateHelperScripts(options: DockerComposeGeneratorOptions): Promise<void> {
    const scripts = {
  ...
  private async generateEnvironmentFiles(options: DockerComposeGeneratorOptions): Promise<void> {
    const environments = ['development', 'staging', 'production'];
  ...
  private async generateSwarmConfig(options: DockerComposeGeneratorOptions): Promise<void> {
    const swarmConfig = {
      version: options.version,
...
`;
  ...
  private transformServices(services: readonly DockerComposeService[]): Record<string, any> {
  ...
  private transformNetworks(networks: readonly DockerComposeNetwork[]): Record<string, any> {
  ...
  private transformVolumes(volumes: readonly DockerComposeVolume[]): Record<string, any> {
  ...
  private transformSecrets(secrets: readonly DockerComposeSecret[]): Record<string, any> {
  ...
  private transformConfigs(configs: readonly DockerComposeConfig[]): Record<string, any> {
  ...
  private getEnvironmentServiceOverrides(services: readonly DockerComposeService[], env: string): Record<string, any> {
  ...
  private addDevelopmentServices(services: readonly DockerComposeService[]): DockerComposeService[] {
  ...
  private getProductionServices(services: readonly DockerComposeService[]): Record<string, any> {
    return services.reduce((acc, service) => {
      acc[service.name] = {
        ...service,
        restart: 'unless-stopped',
  ...
  private getProductionVolumes(volumes: readonly DockerComposeVolume[]): Record<string, any> {
  ...
  private getSwarmServices(services: readonly DockerComposeService[]): Record<string, any> {
    return services.reduce((acc, service) => {
      acc[service.name] = {
        ...service,
  ...
  private getSwarmVolumes(volumes: readonly DockerComposeVolume[]): Record<string, any> {
    return volumes.reduce((acc, volume) => {
      acc[volume.name] = {
        driver: 'local',
        driverOpts: {
...
`;
  ...
  private generateRestartScript(options: DockerComposeGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private generateRestoreScript(options: DockerComposeGeneratorOptions): string {
    return `#!/bin/bash
set -e
...
`;
  ...
  private getEnvironmentVariables(options: DockerComposeGeneratorOptions, env: string): Record<string, string> {
    const baseVars = {
  ...
  private getExampleEnvironmentVariables(options: DockerComposeGeneratorOptions): Record<string, string> {
    return {
      PROJECT_NAME: options.projectName,

...
export class DockerGenerator extends BaseGenerator<DockerGeneratorOptions> {
	...
	private async generateSecurityScanning(
		options: DockerGeneratorOptions,
	): Promise<void> {
	...
	private async generateHealthCheck(
		options: DockerGeneratorOptions,
	): Promise<void> {
...
`;
	 ...
	 */
	private async generateLoggingConfig(
		options: DockerGeneratorOptions,
	): Promise<void> {
		const loggingConfig = {
			fluentd: {
	 ...
	 */
	private async generateSecretsManagement(
		options: DockerGeneratorOptions,
	): Promise<void> {
		const secretsConfig = {
	 ...
	 */
	private async generateVulnerabilityScanning(
		options: DockerGeneratorOptions,
	): Promise<void> {
	 ...
	 */
	private async generateMultiArchSupport(
		options: DockerGeneratorOptions,
	): Promise<void> {
	 ...
	 */
	private async generateCachingConfig(
		options: DockerGeneratorOptions,
		config: DockerConfig,
	): Promise<void> {
		const cachingConfig = {
	 ...
	 * Generate container registry integration
	 */
	private async generateRegistryIntegration(
		options: DockerGeneratorOptions,
	): Promise<void> {

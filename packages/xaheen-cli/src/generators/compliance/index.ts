...
export const COMPLIANCE_GENERATORS = {
  'nsm-security': {
    ...
    description: 'Generate Norwegian Security Authority (NSM) compliant security implementations',
  ...
  'gdpr-compliance': {
    ...
    description: 'Generate GDPR-compliant data protection and privacy implementations',
    generator: 'gdpr.generator',
    lawfulBases: ['consent', 'contract', 'legal-obligation', 'vital-interests', 'public-task', 'legitimate-interests'],
    features: [
      'Consent management',
      'Data subject rights',
      'Privacy by design',
 ...
 */
export function getComplianceGeneratorConfig(type: keyof typeof COMPLIANCE_GENERATORS) {

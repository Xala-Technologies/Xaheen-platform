...
describe("CommandParser", () => {
  ...
  describe("Command Parsing", () => {
    ...
    it("should handle AI code command", async () => {
      const argv = ["node", "xaheen", "ai", "code", "create a button component"];
  ...
  describe("Make Commands (Laravel-style)", () => {
    ...
    it("should parse make:component with AI options", async () => {
      const argv = ["node", "xaheen", "make:component", "Button", "--ai", "--test"];
  ...
  describe("Security Commands", () => {
    it("should parse security audit command with options", async () => {
      const argv = ["node", "xaheen", "security-audit", "--severity", "high", "--format", "json"];
    ...
    it("should parse compliance report command", async () => {
      const argv = ["node", "xaheen", "compliance-report", "--standards", "gdpr,owasp"];
  ...
  describe("Option Parsing", () => {
    it("should parse common options correctly", async () => {
      const argv = ["node", "xaheen", "project", "create", "test", "--verbose", "--dry-run", "--config", "/path/to/config"];
    ...
    it("should handle boolean flags correctly", async () => {
      const argv = ["node", "xaheen", "make:component", "Button", "--ai", "--test", "--withStories"];

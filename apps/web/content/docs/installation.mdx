...
git clone https://github.com/Xala-Technologies/Xaheen-platform.git
cd xaheen
...
- **GitHub Releases**: [View releases](https://github.com/Xala-Technologies/Xaheen-platform/releases)

					...
					{isLoading ? (
						<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
							{Array.from({ length: 9 }).map((_, i) => (
								...
								>
									<div className="mb-3 h-5 bg-muted rounded" />
									<div className="mb-4 h-4 bg-muted rounded w-3/4" />

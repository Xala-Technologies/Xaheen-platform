	...
	const mockDecisions: Decision[] = [
		{
			...
			description:
				"Standardized on Xala UI System v5.0 for consistency and compliance",
		...
		},
		{
			...
			description:
				"Selected PostgreSQL over MySQL for better JSON support and performance",
		...
		},
		{
			...
			description:
				"Split monolith into focused microservices for better scalability",
	...
	const mockRecommendations: Recommendation[] = [
		{
			...
			description:
				"Add Redis caching to reduce database load and improve response times",
			priority: "high",
		...
		},
		{
			...
			description:
				"Implement security headers for better protection against common attacks",
			priority: "high",
			category: "security",
	...
	const contextRecommendations = useMemo(() => {
		...
		if (!projectContext.hasDatabase) {
			recommendations.unshift({
				...
				description:
					"Your project could benefit from a database for persistent data storage",
				priority: "high",
		...
		if (projectContext.complianceLevel !== "Enterprise") {
			recommendations.unshift({
				...
				description:
					"Consider upgrading to enterprise compliance for production deployment",
				priority: "medium",
					...
					<Stack direction="vertical" gap="sm">
						...
						<Stack direction="vertical" gap="xs">
							...
							<Stack direction="horizontal" gap="sm" justify="between">
								...
								<Badge
									variant={projectContext.hasBackend ? "success" : "outline"}
									size="xs"
								>
							...
							<Stack direction="horizontal" gap="sm" justify="between">
								...
								<Badge
									variant={projectContext.hasDatabase ? "success" : "outline"}
									size="xs"
								>
					...
					<Stack direction="horizontal" gap="md" wrap>
						<Stack direction="vertical" gap="xs" align="center">
							<Typography
								variant="body"
								weight="semibold"
								color={taskSummary.completed > 0 ? "success" : "muted"}
							>
						...
						<Stack direction="vertical" gap="xs" align="center">
							<Typography
								variant="body"
								weight="semibold"
								color={taskSummary.running > 0 ? "warning" : "muted"}
							>
								{taskSummary.running}
							</Typography>
							<Typography variant="caption" color="muted">
						...
						<Stack direction="vertical" gap="xs" align="center">
							<Typography
								variant="body"
								weight="semibold"
								color={taskSummary.failed > 0 ? "destructive" : "muted"}
							>
								{taskSummary.failed}
							</Typography>
							<Typography variant="caption" color="muted">
								...
								<Card key={decision.id} variant="ghost" padding="sm">
									<Stack direction="vertical" gap="xs">
										...
										>
											...
											<Badge
												variant={getImpactColor(decision.impact)}
												size="xs"
											>

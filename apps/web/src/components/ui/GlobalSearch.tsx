/**
 * Global Search Component - Xala UI System v5.0.0 CVA Compliant
 ...
 * - Simplified to use semantic Tailwind classes
...
import { ArrowUpDown, Clock, Command, Hash, Search } from "lucide-react";
				...
				>
					<Stack direction="horizontal" gap="md" align="center">
						...
						<Input
							...
							placeholder={t(
								"search.placeholder",
								"Search pages, components, and documentation...",
							)}
							style={{
								border: "none",
								outline: "none",

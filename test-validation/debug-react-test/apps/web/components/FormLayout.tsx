{{!-- Template: FormLayout.tsx.hbs --}}
{{!-- Category: frontend --}}
{{!-- Type: component --}}
{{!-- Framework: next --}}
{{!-- Migrated from: /Volumes/Development/Xaheen Enterprise/xaheen/apps/cli/templates/frontend/react/next/src/components/layouts/FormLayout.tsx.hbs --}}

{{!-- Template: dashboard-norwegian.tsx.hbs --}}
{{!-- Category: frontend --}}
{{!-- Type: component --}}
{{!-- Framework: next --}}
{{!-- Migrated from: /Volumes/Development/Xaheen Enterprise/xaheen/apps/cli/templates/frontend/react/next/src/pages/dashboard-norwegian.tsx.hbs --}}
{{!-- 

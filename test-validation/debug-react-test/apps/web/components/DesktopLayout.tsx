{{!-- Template: DesktopLayout.tsx.hbs --}}
{{!-- Category: frontend --}}
{{!-- Type: component --}}
{{!-- Framework: next --}}
{{!-- Migrated from: /Volumes/Development/Xaheen Enterprise/xaheen/apps/cli/templates/frontend/react/next/src/components/layouts/DesktopLayout.tsx.hbs --}}
...
import { Typography, Card, Stack } from '@xaheen-ai/design-system';

{{!-- Template: dashboard.tsx.hbs --}}
{{!-- Category: frontend --}}
{{!-- Type: component --}}
{{!-- Framework: next --}}
{{!-- Migrated from: /Volumes/Development/Xaheen Enterprise/xaheen/apps/cli/templates/frontend/react/next/src/pages/dashboard.tsx.hbs --}}
...
/**
 * {{componentName}} - Professional Dashboard Page Template - Xala UI System Compliant
      ...
      <Box variant="main" spacing="16">
        <Container>
          ...
          <Grid columns="responsive" spacing="6">
            {/* Recent Activity */}
            <Box gridColumn={{{{raw}}}}{{ lg: "span 2" }}{{{{/raw}}}}>
              <Card variant="elevated" spacing="8">

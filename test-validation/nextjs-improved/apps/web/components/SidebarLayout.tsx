...
export default function SidebarLayout({
  ...
  const renderSidebarHeader = (): React.ReactElement | null => {
  ...
  const renderDesktopSidebar = (): React.ReactElement => {
  ...
  const renderMobileSidebar = (): React.ReactElement | null => {
  ...
  const renderToggleButton = (): React.ReactElement | null => {
  ...
  const getMainContentMargin = (): string => {
    ...
    return sidebarPosition === 'left' ? "template string" : "template string";
  };

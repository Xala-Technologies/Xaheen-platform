...
export default function MobileLayout({
  ...
  const renderMobileHeader = (): React.ReactElement => (
    <MobileHeader
  ...
  const renderBottomNavigation = (): React.ReactElement => (
    <BottomNavigation
      backgroundColor="card"
      borderTop="1"
      padding="2"
  ...
  const renderActionBar = (): React.ReactElement | null => {
  ...
  const renderMenuDrawer = (): React.ReactElement => (
    <Drawer
      open={isMenuOpen}
...
import { Typography, Card } from '@xaheen-ai/design-system';

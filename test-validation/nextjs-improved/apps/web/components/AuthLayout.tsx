...
export default function AuthLayout({
  ...
  const renderNorwegianProviders = (): React.ReactElement | null => {
              ...
              <Stack direction="horizontal" align="center" spacing="3" width="full">
                ...
                <Stack direction="vertical" align="start" spacing="0" flex="1">
                  <Typography variant="body" size="md" weight="medium">
                    {t("template string", provider.name)}
                  </Typography>
  ...
  const renderInternationalProviders = (): React.ReactElement | null => {
  ...
  const renderSecurityIndicators = (): React.ReactElement | null => {
  ...
  const renderPrivacyNotice = (): React.ReactElement | null => {
  ...
  const renderGuestAccess = (): React.ReactElement | null => {
  ...
  const renderUtilityActions = (): React.ReactElement => (

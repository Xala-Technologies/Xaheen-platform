{{!-- Template: usePlatform.ts.hbs --}}
{{!-- Category: frontend --}}
{{!-- Type: file --}}
{{!-- Framework: next --}}
{{!-- Migrated from: /Volumes/Development/Xaheen Enterprise/xaheen/apps/cli/templates/frontend/react/next/src/hooks/usePlatform.ts.hbs --}}
